...
function padLeft(text: string, amount: number, padding = "  ") {
  let result = "";
...
function outputTree(root: DirNode, nest = 0) {
...
function treeSum(root: DirNode): number {
...
const sampleDirTree = getDirectoryTree(sample);
const puzzleDirTree = getDirectoryTree(puzzle);
